  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-lightmauve text-darkgray">
      <div className="text-center p-8 max-w-lg mx-auto">
        ...
        <a 
          href="/" 
          className="inline-block px-8 py-3 text-lg font-medium text-purewhite bg-primary rounded-full hover:bg-softpink transition-colors duration-300 transform hover:bg-secondary"
        >
          Kembali ke Beranda
        </a>
      </div>
